...
const getGradeFromPercentage = (percentage: number): string => {
    ...
    if (percentage >= 35) return 'Third Class';
    return 'Fail';
}
                                    ...
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>
                                            <Button
                                                ...
                                                onClick={() => setViewingFile({ url: qual.marksheetUrl, name: "Marksheet", title: `${qual.examination} Marksheet`})}
                                                disabled={!qual.marksheetUrl}
                                            >
                                                View
                                            </Button>
                                        </TableCell>
